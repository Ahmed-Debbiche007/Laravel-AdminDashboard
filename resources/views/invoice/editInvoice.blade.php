...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Edit Invoice</h1>
    ...
    @endif
    <form method="POST" action="/Invoice/{{$invoices->id}}" class="user">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control form-control-user" name="timbreFiscal" placeholder="{{$invoices->timbreFiscal}}" value="{{$invoices->timbreFiscal}}" required>
                            </div>
