...
<div class="row">
    ...
    <div class="col-lg-8 order-lg-1">
                ...
                <form method="POST" action="/client/{{$clients->id}}" autocomplete="off" id="form">
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="tel">Numéro de téléphone<span class="small text-danger">*</span></label>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"><i class="bi bi-shield-check"></i> Paramètre de Confidentialité</h6>
            </div>
